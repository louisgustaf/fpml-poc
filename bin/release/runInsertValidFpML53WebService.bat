...
"%_JAVACMD%" %JAVA_OPTS% -Dlog4j.configuration=file:./log4j.properties -classpath jpm-chase-poc-0.0.1-SNAPSHOT.jar com.cpqi.poc.client.WebServiceClientPOST data/test/valid.xml 
